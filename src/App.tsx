...
const SERVICES: Service[] = [
  ...
  {
    title: 'Массаж лица и тела Виватон',
    shortDescription: 'Массаж с препаратами «Виватон» улучшает обменные процессы в тканях, способствует восстановлению и заметно выравнивает кожу.',
    description: 'Специальная техника массажа способствует глубокому усвоению веществ, входящих в состав препаратов «Виватон»\nБлагодаря им нормализуются и ускоряются обменные процессы в соединительных и мышечных тканях, создается питательная среда для их восстановления. Значительно улучшается качество кожи, она выравнивается и полируется\nПродолжительность: 60 - 90 мин.',
    icon: <TestTubeDiagonal size={40} strokeWidth={1} />
  },
  {
    title: 'Остеопатия',
  ...
  {
    title: 'Тренерство',
    shortDescription: 'Экспертная деятельность в фитнесе и силовых тренировках: индивидуальные программы, мотивационная поддержка и чемпионский опыт для комплексного сопровождения на пути к силе, здоровью и физическому совершенству.',
    description: 'Экспертная деятельность в сфере фитнеса и силовых тренирчыовок, включающая:\n— разработку индивидуальных программ для достижения максимальных результатов\n— всестороннюю мотивационную поддержку и укрепление уверенности клиентов\n— применение уникального чемпионского опыта в построении тренировочного процесса\n— специализированные направления работы за рамками стандартного тренинга\n\nГлавная цель — комплексное сопровождение на пути к силе, здоровью и физическому совершенству.',
    icon: <Dumbbell size={40} strokeWidth={1} />
  }
];
...
const SPECIALISTS: Specialist[] = [
  ...
  {
    name: 'Игорь Николаевич Баруков',
    role: 'Тренер',
    image: 'e.jpg',
    largeImage: 'e.jpg',
    description: '-мастер спорта международного класса\n-4-х кратный чемпион мира по пауэрлифтингу\n\nСтаж работы в тренерской деятельности более 10 лет.\n\nПерфекционист в профессии, целеустремлен, порядочен и эмпатичен\nЗакончил:\n-ГОУСПО Московское медицинское училище\n\n-Российский Университет Дружбы Народов\n\n-Институт восстановительной медицины. Специализация - медицинский массаж, спортивный массаж'
  },
  {
    name: 'Анжела Юрьевна Астахова',
    role: 'Косметолог',
    image: 'f.jpg',
    largeImage: 'f.jpg',
    description: 'косметолог-эстетист с медицинским стажем более 29 лет и опытом работы в косметологии 18 лет.\n\nОна окончила медицинское училище г. Ельца по специальности «медицинская сестра широкого профиля», а затем прошла десятки курсов повышения квалификации в области эстетической и аппаратной косметологии, мезотерапии и физиотерапии.\n\nАнжела Юрьевна регулярно обучается работе на современных косметологических и физиотерапевтических аппаратах, осваивает новые методики ухода за кожей лица и тела и подтверждает квалификацию сертификатами ведущих учебных центров Москвы и Санкт‑Петербурга.'
  }
];
        ...
        <div className="max-w-7xl grid md:grid-cols-2 gap-12 items-center px-8 hero-content hero-content-centered">
          <motion.div className="space-y-10" initial={{ opacity: 0, y: 36 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9, ease: [0.22, 1, 0.36, 1] }}>
            ...
            <div className="hero-proof-strip" aria-label="Преимущества студии">
              ...
              <span>10 направлений работы</span>
            </div>
